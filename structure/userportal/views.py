...
from structure.models import User,About,Price,Journal,WebFeatureSchema,Appointment
...
from structure.userportal.forms import BookingForm,UpdateSessionForm ,JournalForm,Addtherapist,SessionForm,AppointmentForm,ContactForm,FeedbackForm
